...
<!-- 預設載入CSS -->
<link id="dynamic-css" rel="stylesheet" href="<?php echo BASE_PATH ; ?>css/style-allpost.css?v=initial">
<!-- 使用defer載入JavaScript，避免阻塞 -->
<script defer>
    document.addEventListener("DOMContentLoaded", function() {
        const timestamp = new Date().getTime();
        document.getElementById("dynamic-css").href = `<?php echo BASE_PATH ; ?>css/style-allpost.css?v=${timestamp}`;
        const script = document.createElement("script");
        script.src = `<?php echo BASE_PATH ; ?>js/script-allpost.js?v=${timestamp} defer`;
...
<header class="w3-display-container w3-content w3-wide" style="max-width:100%;" id="home">
  ...
  <div id="header-title"><p>All Post</p><div>
  </header>
